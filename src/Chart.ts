...
export class Chart {
    ...
    private renderBars(groupedBars: Bar[], maxPrice: number, priceRange: number, leftPadding: number, rightPadding: number, width: number, barWidth: number, barSpacing: number) {
